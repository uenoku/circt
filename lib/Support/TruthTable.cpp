...
static llvm::APInt expandTruthTableToInputSpaceSmall(const llvm::APInt &tt,
...
llvm::APInt circt::detail::expandTruthTableToInputSpace(
    const llvm::APInt &tt, ArrayRef<unsigned> mapping,
    unsigned numExpandedInputs) {
  unsigned numOrigInputs = mapping.size();
  unsigned expandedSize = 1U << numExpandedInputs;
