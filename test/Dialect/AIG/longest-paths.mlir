// RUN: circt-opt %s --split-input-file --pass-pipeline='builtin.module(aig-print-longest-path-analysis{test=true})' --verify-diagnostics

// expected-remark-re @below {{fanOut=Object($root.x[0]), fanIn=Object($root.a[0], delay=4, history=[{{.+}}])}}
// expected-remark-re @below {{fanOut=Object($root.x[0]), fanIn=Object($root.b[0], delay=4, history=[{{.+}}])}}
...
// expected-remark-re @below {{fanOut=Object($root.x[1]), fanIn=Object($root.a[1], delay=1, history=[{{.+}}])}}
// expected-remark-re @below {{fanOut=Object($root.x[1]), fanIn=Object($root.b[1], delay=1, history=[{{.+}}])}}
...
// expected-remark-re @below {{fanOut=Object($root.x[0]), fanIn=Object($root.a[1], delay=2, history=[{{.+}}])}}
// expected-remark-re @below {{fanOut=Object($root.x[0]), fanIn=Object($root.a[2], delay=1, history=[{{.+}}])}}
...
// expected-remark-re @below {{fanOut=Object($root.x[0]), fanIn=Object($root.a[1], delay=0, history=[{{.+}})])}}
...
// expected-remark @below {{fanOut=Object($root.x[0]), fanIn=Object($root.r[0], delay=1)}}
// expected-remark-re @below {{fanOut=Object($root.x[0]), fanIn=Object($root.a[0], delay=1, history=[{{.+}}])}}
hw.module private @firreg(in %a : i1, in %clk : !seq.clock, out x : i1) {
  // expected-remark @below {{root=firreg, fanOut=Object($root.r[0]), fanIn=Object($root.r[0], delay=1)}}
  // expected-remark-re @below {{root=firreg, fanOut=Object($root.r[0]), fanIn=Object($root.a[0], delay=1, history=[{{.+}}])}}
...
hw.module private @compreg(in %a : i1, in %clk : !seq.clock, out x : i1) {
  // expected-remark @below {{root=compreg, fanOut=Object($root.r[0]), fanIn=Object($root.r[0], delay=1)}}
  // expected-remark-re @below {{root=compreg, fanOut=Object($root.r[0]), fanIn=Object($root.a[0], delay=1, history=[{{.+}}])}}
...
// expected-remark-re @below {{fanOut=Object($root.x[0]), fanIn=Object($root.a[0], delay=2, history=[{{.+}}])}}
// expected-remark-re @below {{fanOut=Object($root.x[0]), fanIn=Object($root.b[0], delay=2, history=[{{.+}}])}}
hw.module private @oracle(in %a : i8, in %b : i8, out x : i8) {
  %0 = comb.add %a, %b : i8
  hw.output %0 : i8
}
