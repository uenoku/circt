...
// CHECK-NOT: attributes
// CHECK: hw.module @issue1246_assert(%clock: i1) attributes {comment.prologue = "VCS coverage exclude_file", output_file = #hw.output_file<"dir3/", excludeFromFileList, includeReplicatedOps>}
// CHECK: sv.assert
...
// CHECK-SAME: attributes {comment.prologue = "VCS coverage exclude_file"}
// CHECK: sv.assume
// CHECK: foo_assume
