...
// RUN: circt-opt %s --pass-pipeline='builtin.module(synth-exact-synthesis{kind=dig sat-solver=z3})' | FileCheck %s --check-prefix=DIG
...
// DIG-LABEL: hw.module @and_tt
// DIG: %[[DOT:.+]] = synth.dig.dot_inv
// DIG-NEXT: hw.output %[[DOT]] : i1
