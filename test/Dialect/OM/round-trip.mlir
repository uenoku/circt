...
om.class @NestedField4() {
  ...
  // CHECK: %[[field0:.+]] = om.object.field %[[nested]][@foo] : (!om.class.type<@NestedField3>) -> !om.class.type<@NestedField2>
  // CHECK: %[[field1:.+]] = om.object.field %[[field0]][@bar] : (!om.class.type<@NestedField2>) -> !om.class.type<@NestedField1>
  // CHECK: %{{.+}} = om.object.field %[[field1]][@baz] : (!om.class.type<@NestedField1>) -> i1
