...
om.class @ElaboratedWidget() -> (widget: !om.class.type<@Widget>, blue: i8) {
  %0 = om.constant 5 : i8
  %1 = om.constant 6 : i32
  // CHECK: %[[widget:.+]] = om.elaborated_object @Widget(blue_1: %{{.+}} : i8, green_1: %{{.+}} : i32) : !om.class.type<@Widget>
  %2 = om.elaborated_object @Widget(blue_1: %0 : i8, green_1: %1 : i32) : !om.class.type<@Widget>
