...
module {
  ...
  // CHECK-NEXT:    om.object.field  : (!om.class.type<@Conflict_B>) -> i1
  ...
  // CHECK-NEXT:    om.object.field  : (!om.class.type<@Conflict_module_0>) -> i1
  ...
  module attributes {om.namespace = "B"} {
    ...
    om.class @UseConflict() -> (c: i1) {
      %0 = om.object @Conflict() : () -> !om.class.type<@Conflict>
      %1 = om.object.field  : (!om.class.type<@Conflict>) -> i1
