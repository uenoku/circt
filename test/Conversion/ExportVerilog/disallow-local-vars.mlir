...
// RUN: circt-opt --pass-pipeline='builtin.module(hw.design(test-apply-lowering-options{options="disallowLocalVariables"}, export-verilog))'  %s | FileCheck %s --check-prefix=DISALLOW -strict-whitespace
