...
// RUN: circt-lec-script %t.mlir %s -c1=partial_product_4 -c2=partial_product_4
...
// RUN: circt-lec-script %t.mlir %s -c1=partial_product_zext -c2=partial_product_zext
...
// RUN: circt-lec-script %t.mlir %s -c1=partial_product_square -c2=partial_product_square
...
// RUN: circt-lec-script %t.mlir %s -c1=partial_product_square_zext -c2=partial_product_square_zext
...
// RUN: circt-lec-script %t.mlir %s -c1=partial_product_sext -c2=partial_product_sext
...
// RUN: circt-lec-script %t.mlir %s -c1=pos_partial_product_4 -c2=pos_partial_product_4
...
// RUN: circt-lec-script %t.mlir %s -c1=pos_partial_product_zext -c2=pos_partial_product_zext
...
// RUN: circt-lec-script %t.mlir %s -c1=compress_3 -c2=compress_3
...
// RUN: circt-lec-script %t.mlir %s -c1=compress_6 -c2=compress_6
