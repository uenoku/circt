...
// RUN: circt-lec-script %s %t.mlir --c1 functional_reduction_sat --c2 functional_reduction_sat
...
// nodes.
// RUN: circt-lec-script %s %t.mlir --c1 functional_reduction_supported_ops_sat --c2 functional_reduction_supported_ops_sat
...
// RUN: circt-lec-script %s %t.mlir --c1 functional_reduction_inversion_equiv_sat --c2 functional_reduction_inversion_equiv_sat
...
// RUN: circt-lec-script %s %t.mlir --c1 functional_reduction_xor_inv_sat --c2 functional_reduction_xor_inv_sat
...
// RUN: circt-lec-script %s %t.mlir --c1 test_dot --c2 test_dot
...
// RUN: circt-lec-script %s %t.mlir --c1 test_majority --c2 test_majority
...
// RUN: circt-lec-script %s %t.mlir --c1 test_onehot --c2 test_onehot
...
// RUN: circt-lec-script %s %t.mlir --c1 functional_reduction_mux_inv_sat --c2 functional_reduction_mux_inv_sat
...
// RUN: circt-lec-script %s %t.mlir --c1 test_gamble --c2 test_gamble
