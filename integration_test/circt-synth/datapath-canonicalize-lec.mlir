...
// RUN: circt-lec-script %t.mlir %s -c1=partial_product_sext_3 -c2=partial_product_sext_3
...
// RUN: circt-lec-script %t.mlir %s -c1=partial_product_sext_6 -c2=partial_product_sext_6
...
// RUN: circt-lec-script %t.mlir %s -c1=sext_compress -c2=sext_compress
