...
// RUN: circt-lec-script %t.mlir %s -c1=priority_mux_18_depth -c2=priority_mux_18_depth
...
// RUN: circt-lec-script %t.mlir %s -c1=index_to_balanced_mux -c2=index_to_balanced_mux
