...
// RUN: circt-synth %s --target-ir=aig --until-before mapping --greedy-cut-rewrite-db-files=%t.pre.mlir,%t.db.mlir --greedy-cut-rewrite-max-iterations=1 -o %t.greedy.mlir
