...
// RUN: circt-lec-script %t.mlir %s -c1=divmodu -c2=divmodu
...
// RUN: circt-lec-script %t.mlir %s -c1=divmodu_power_of_two -c2=divmodu_power_of_two
...
// RUN: circt-lec-script %t.mlir %s -c1=divmods -c2=divmods
...
// RUN: circt-lec-script %t.mlir %s -c1=divmod_mix_constant -c2=divmod_mix_constant
...
// RUN: circt-lec-script %t.mlir %s -c1=divmodu_constants -c2=divmodu_constants
...
// RUN: circt-lec-script %t.mlir %s -c1=divmods_constants -c2=divmods_constants
...
// RUN: circt-lec-script %t.mlir %s -c1=const_divmod_mods_neg1_i3 -c2=const_divmod_mods_neg1_i3
