...
// RUN: circt-lec-script %t.mlir %s -c1=icmp_unsigned_ripple_carry -c2=icmp_unsigned_ripple_carry
...
// RUN: circt-lec-script %t.mlir %s -c1=icmp_unsigned_sklanskey -c2=icmp_unsigned_sklanskey
...
// RUN: circt-lec-script %t.mlir %s -c1=icmp_unsigned_kogge_stone -c2=icmp_unsigned_kogge_stone
...
// RUN: circt-lec-script %t.mlir %s -c1=icmp_unsigned_brent_kung -c2=icmp_unsigned_brent_kung
...
// RUN: circt-lec-script %t.mlir %s -c1=icmp_signed -c2=icmp_signed
...
// RUN: circt-lec-script %t.mlir %s -c1=icmp_eq_ne -c2=icmp_eq_ne
