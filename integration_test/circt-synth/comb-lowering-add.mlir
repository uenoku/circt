...
// RUN: circt-lec-script %t.mlir %s -c1=add_ripple_carry -c2=add_ripple_carry
...
// RUN: circt-lec-script %t.mlir %s -c1=add_sklanskey -c2=add_sklanskey
...
// RUN: circt-lec-script %t.mlir %s -c1=add_kogge_stone -c2=add_kogge_stone
...
// RUN: circt-lec-script %t.mlir %s -c1=add_brent_kung -c2=add_brent_kung
