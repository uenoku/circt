...
// RUN: circt-lec-script %t.mlir %s -c1=bit_logical -c2=bit_logical
...
// RUN: circt-lec-script %t.mlir %s -c1=parity -c2=parity
hw.module @parity(in %arg0: i4, out out: i1) {
  %0 = comb.parity %arg0 : i4
  hw.output %0 : i1
}

// RUN: circt-lec-script %t.mlir %s -c1=sub -c2=sub
...
// RUN: circt-lec-script %t.mlir %s -c1=shift5 -c2=shift5
