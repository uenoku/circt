...
TEST(EvaluatorTests, InstantiateObjectWithFieldAccess) {
  ...
  builder.setInsertionPointToStart(&body);
  auto object = ObjectOp::create(builder, innerCls, body.getArguments());
  auto field = ObjectFieldOp::create(
      builder, builder.getI32Type(), object,
      FlatSymbolRefAttr::get(builder.getStringAttr("field")));
...
om.class @ReferenceEachOther() -> (field1: !ty, field2: !ty) {
  ...
  %2 = om.object.field %1[@n] : (!ty) -> !ty
  %3 = om.object.field %2[@n] : (!ty) -> !ty
  %val = om.object.field %3[@val] : (!ty) -> !om.string
...
om.class @IntegerBinaryArithmeticObjects() -> (result: !om.integer) {
  ...
  %1 = om.object.field  : (!om.class.type<@Class1>) -> !om.integer

  %2 = om.object @Class2() : () -> !om.class.type<@Class2>
  %3 = om.object.field  : (!om.class.type<@Class2>) -> !om.integer
...
om.class @ListConcatField() -> (result: !om.list<!om.integer>){
  ...
  %1 = om.constant #om.integer<1 : i8> : !om.integer
  %l0 = om.list_create %0, %1 : !om.integer
  %l1 = om.object.field  : (!om.class.type<@ListField>) -> !om.list<!om.integer>
  %concat = om.list_concat %l0, %l1 : !om.list<!om.integer>
  om.class.fields %concat : !om.list<!om.integer>
}
)MLIR";
...
om.class @ListConcatPartialCycle() -> (result: !om.list<!om.any>){
  ...
  %1 = om.object.field  : (!om.class.type<@Child>) -> !om.list<!om.any>
  %2 = om.object @Child(%10) : (!om.any) -> !om.class.type<@Child>
  %3 = om.object.field  : (!om.class.type<@Child>) -> !om.list<!om.any>
...
om.class @OuterClass2()  -> (om: !om.class.type<@InnerClass2>) {
  ...
  %2 = om.object.field  : (!om.class.type<@Any>) -> !om.any
  %3 = om.object @Any() : () -> !om.class.type<@Any>
  %4 = om.object.field  : (!om.class.type<@Any>) -> !om.any
...
om.class @OuterClass1()  -> (om: !om.any) {
  ...
  %3 = om.object.field  : (!om.class.type<@OuterClass2>) -> !om.class.type<@InnerClass2>
  %4 = om.any_cast %3 : (!om.class.type<@InnerClass2>) -> !om.any
  %5 = om.object @OuterClass2() : () -> !om.class.type<@OuterClass2>
  %6 = om.object.field  : (!om.class.type<@OuterClass2>) -> !om.class.type<@InnerClass2>
...
om.class @Foo(
  ...
  %6 = om.object.field  : (!om.class.type<@Bar>) -> !om.integer
  %7 = om.unknown : !om.integer
  %8 = om.object @Baz() : () -> !om.class.type<@Baz>
  %9 = om.object.field  : (!om.class.type<@Baz>) -> !om.integer
...
om.class @Foo(
  ...
  %1 = om.object.field  : (!om.class.type<@Bar>) -> !om.integer
  %2 = om.object.field  : (!om.class.type<@Bar>) -> !om.integer
...
om.class @Foo(
  ...
  %0 = om.object.field %unknown_outer[@leaf] : (!om.class.type<@Outer>) -> !om.class.type<@Leaf>
  %1 = om.object.field %0[@value] : (!om.class.type<@Leaf>) -> !om.integer
...
om.class @TestHarness_Class(%basepath: !om.frozenbasepath) -> (result: !om.list<!om.any>) {
  ...
  %2 = om.object.field  : (!om.class.type<@Dut_Class>) -> !om.list<!om.any>
...
om.class @Parameter_True_Cycle_Top() -> () {
  ...
  %in = om.object.field  : (!om.class.type<@Parameter_True_Cycle>) -> i1
  om.class.fields
}
...
om.class @Parameter_False_Cycle_Top() -> () {
  ...
  %in = om.object.field  : (!om.class.type<@Parameter_False_Cycle>) -> i1
  om.class.fields
}
...
om.class @SubfieldTrue() -> () {
  ...
  %true = om.object.field  : (!om.class.type<@ReturnTrue>) -> i1
...
om.class @SubfieldFalse() -> () {
  ...
  %false = om.object.field  : (!om.class.type<@ReturnFalse>) -> i1
...
om.class @Foo_Class(%basepath: !om.frozenbasepath) -> (test1: i1, test2: i1) {
  ...
  %2 = om.object.field  : (!om.class.type<@Domain>) -> !om.string
  %3 = om.object @Domain(%2) : (!om.string) -> !om.class.type<@Domain>
  %4 = om.object.field  : (!om.class.type<@Domain>) -> !om.string
  %5 = om.constant "A" : !om.string
  %6 = om.constant "B" : !om.string
  %7 = om.prop.eq %4, %5 : !om.string
  %8 = om.prop.eq %4, %6 : !om.string
  om.class.fields %7, %8 : i1, i1
}
)MLIR";
  ...
  auto *obj = llvm::cast<evaluator::ObjectValue>(result.value().get());
  auto check = [&](StringRef fieldName, bool expected) {
    auto *field =
        obj->getField(StringAttr::get(&context, fieldName)).value().get();
    ASSERT_TRUE(llvm::isa<evaluator::AttributeValue>(field));
    auto intAttr = llvm::cast<evaluator::AttributeValue>(field)
                       ->getAs<mlir::IntegerAttr>();
    ASSERT_TRUE(intAttr);
    ASSERT_EQ(intAttr.getValue().getZExtValue(), expected ? 1u : 0u);
  };
  check("test1", true);
  check("test2", false);
}
